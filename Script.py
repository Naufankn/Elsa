class script(object):
    START_TXT = """<b>𝙷𝙴𝙻𝙻𝙾 {},
ഞാൻ ഒരു 𝐆𝐑𝐎𝐔𝐏 𝐌𝐀𝐍𝐀𝐆𝐈𝐍𝐆 𝐁𝐎𝐓 ആണ്, എന്നെ നിങ്ങളുടെ ഗ്രൂപ്പിൽ ആഡ് ചെയ്യാൻ നോക്കി സമയം കളയണ്ട, എന്നെ 𝗪𝗢𝗥𝗟𝗗 𝗪𝗜𝗗𝗘 𝗠𝗢𝗩𝗜𝗘𝗦  𝗧𝗘𝗔𝗠  ഗ്രൂപ്പിൽ മാത്രമേ ആഡ് ചെയ്യാൻ കഴിയൂ...!!!
...
<b>COMMAND</b> : /font your text (optional)
 ...
 <i>This feature added by @WORLD_WIDE_MOVIES01"""
    JSON_TXT = """<b>JSON:</b>
...
╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗
▫️<a href=https://t.me/WORLD_WIDE_MOVIES_GROUP> ᴄʜᴀɴɴᴇʟ </a>

▫️<a href=https://t.me/OTT_UPDATES_WORLD_WIDE_MOVIES> sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ </a>
╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╝</b>"""
...
1️⃣ സിനിമയുടെ സ്പെല്ലിങ്ങ് ഗൂഗിളിൽ ഉള്ളത് പോലെ ആണോ നിങ്ങൾ അടിച്ചത് എന്ന് ഉറപ്പ് വരുത്തുക..!!
 ...
 2️⃣ നിങ്ങൾ ചോദിച്ച സിനിമ OTT റിലീസ് ആയതാണോ എന്ന് @OTT_UPDATES_WORLD_WIDE_MOVIES യിൽ ചെക്ക് ചെയ്യുക..!!

3️⃣ മൂവിക്ക് വേണ്ടി മെസ്സേജ് അയക്കുമ്പോൾ മൂവിയുടെ പേര് ഇറങ്ങിയ വർഷം മാത്രം അയക്കുക..!!

4⃣ ‼ 𝖱𝖾𝗉𝗈𝗋𝗍 𝗍𝗈 𝖺𝖽𝗆𝗂𝗇 ▶ @WORLD_WIDE_MOVIES00</b> """
